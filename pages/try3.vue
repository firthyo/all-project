                  ...
                  <v-expansion-panels>
                    ...
                    >
                      ...
                      <v-expansion-panel-header expand-icon="mdi-menu-down">
                        <v-row>
                          <v-col cols="12">
                            <h2 v-if="!isEditing" style="font-weight: inherit">{{ item.productName }}</h2>
                            <v-text-field
                              v-if="isEditing"
                          ...
                          <v-container>
                            ...
                            <v-card style="margin-top: 30px">
                              ...
                              <v-expansion-panels class="mb-6">
                                <v-expansion-panel v-for="envitem in item.env"
                                >
                                  <v-expansion-panel-header expand-icon="mdi-menu-down"
                                  >
                                    ...
                                    <v-list>
                                      <v-row>
                                        <v-col cols="6">
                                          ...
                                          <v-list-item v-for="keyText in envitem.key">

                                            <v-list-item-title >Key : {{keyText}}</v-list-item-title>
                                          </v-list-item>
                                        </v-col>

                                        <v-col cols="6">
                                          <v-list-item v-for="val in envitem.value">
                                            <v-list-item-title>Value : {{val}}</v-list-item-title>
                                          </v-list-item>
                                        </v-col>
                                      </v-row>
                                    </v-list>
